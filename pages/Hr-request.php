...
$leaveRequests = $requstTable_contr->getAllReqHr();
// $leaveRequests = [];
...
<div class="pagination">
  <?php if($page > 1){?>
     ...
     <a href="home.php?page=requests&status=<?= $filterStatus ?>&pagination_page=<?= $page-1?>">PREV</a>
    <?php } ?>
    <span> page <?=$page?> of  <?=$totalpages?></span>
    <?php if($page < $totalpages){ ?>
        <a href="home.php?page=requests&status=<?= $filterStatus ?>&pagination_page=<?= $page + 1 ?>">NEXT</a>  
    <?php }?>
